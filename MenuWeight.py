...
import sys
#创建游戏窗口
class MenuWeight(QWidget):
    #创建信号
    single_clicked=pyqtSignal()
    double_clicked=pyqtSignal()
    network_clicked=pyqtSignal()
    def __init__(self,parent=None):
        super(MenuWeight,self).__init__(parent)
        self.initui()
    def initui(self):
        #设置窗口大小
        self.setFixedSize(760,650)
        #设置标题
        self.setWindowTitle('五子棋与游戏')
        #设置窗口图标
        ...
        self.single_button=MyButton('source/人机对战_hover.png',
                                    ...
                                    parent=self)
        self.single_button.move(250,150)
        ...
        self.network_button = MyButton('source/联机对战_hover.png',
                                      ...
                                      parent=self)
        self.network_button.move(250, 300)
        ...
        self.double_button = MyButton('source/双人对战_hover.png',
                                      ...
                                      parent=self)
        self.double_button.move(250, 450)
